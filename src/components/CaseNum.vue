<template>
  <div class="case-num">
    <div class="container">
      <div class="title">
        <span>截至 {{ buifyTime(caseNumData.modifyTime) }}全国数据统计</span>
      </div>
    </div>
    <div class="num">
      <ul class="count">
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(247, 76, 49)">
                  {{ getNum(caseNumData.currentConfirmedIncr) }}</em
                >
              </b>
            </div>
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(247, 130, 7)">
                  {{ getNum(caseNumData.confirmedIncr) }}</em
                >
              </b>
            </div>
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(162, 90, 78)">{{
                  getNum(caseNumData.suspectedIncr)
                }}</em>
              </b>
            </div>
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(174, 33, 44)">
                  {{ getNum(caseNumData.curedIncr) }}</em
                >
              </b>
            </div>
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(93, 112, 146)">
                  {{ getNum(caseNumData.deadIncr) }}</em
                >
              </b>
            </div>
            ...
            <div class="create-count">
              <b>
                较昨日<em style="color: rgb(40, 183, 163)">{{
                  getNum(caseNumData.seriousIncr)
                }}</em>
              </b>
            </div>
